function [k0] = semi_causal_open_loop_detecion(theta,c,rho,rho_star,kmax,y,n,threshold_alpha,threshold_beta)
...
%ADAPTIVE DETECTION:
%
% algorithm = 3 - the semi-causal, equipped with open loop detection scheme,  (15a,15b),
%
%Inputs:
