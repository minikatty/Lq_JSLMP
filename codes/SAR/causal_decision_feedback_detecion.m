function [k0] = causal_decision_feedback_detecion(theta,rho,kmax,y,n,threshold_alpha)
...
%ADAPTIVE DETECTION:
%
% algorithm = 2 - the causal, equipped with decision-feedback detection scheme (15a,15c),
%
%Inputs:
